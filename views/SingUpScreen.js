...
import { registerUser } from '../controllers/signController'; // Importamos la función de registro
...
const SignUp = () => {
    ...
    const handleRegister = async () => {
        const success = await registerUser(state.email, state.password, state.confirmPassword);
        if (success) {
            navigation.navigate('Home'); // Navega a Home si el registro es exitoso
        }
    };
